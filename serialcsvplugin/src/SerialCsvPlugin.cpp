...
<OxygenPlugin name="SERIAL_PLUGIN" version="1.0" uuid="674c23a5-590a-4c7f-8aac-a97ed94a0ea5">
...
public:
    ...
    {
        // Testing QML-Messages
        returns.setSigned("NumPorts", 5);
        returns.setString("1", "COM1");
        returns.setString("2", "COM2");
        returns.setString("3", "COM3");
        returns.setString("4", "COM4");
        returns.setString("5", "COM5");
...
OXY_REGISTER_PLUGIN1("SERIAL_PLUGIN", PLUGIN_MANIFEST, SerialCsvChannelPlugin);
